...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for SnapshotEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SnapshotEncoder<'a> {
        #[inline]
    ...
    impl<'a> SnapshotEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_book_complete(&mut self, value: YesNo) {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_last_in_book(&mut self, value: YesNo) {
        ...
        /// GROUP ENCODER
        #[inline]
        pub fn levels_list_encoder(self, count: u16, levels_list_encoder: LevelsListEncoder<Self>) -> LevelsListEncoder<Self> {
            levels_list_encoder.wrap(self, count)
        }

    }

    #[derive(Debug, Default)]
    pub struct LevelsListEncoder<P> {
        parent: Option<P>,
        count: u16,
        index: usize,
        offset: usize,
    ...
    impl<'a, P> Writer<'a> for LevelsListEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
    ...
    impl<'a, P> Encoder<'a> for LevelsListEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
    ...
    impl<'a, P> LevelsListEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
...
pub mod decoder {
    ...
    impl<'a> Reader<'a> for SnapshotDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SnapshotDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SnapshotDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_book_complete(&self) -> YesNo {
            self.get_buf().get_u8_at(self.offset + 20).into()
        }

        /// REQUIRED enum
        #[inline]
        pub fn is_last_in_book(&self) -> YesNo {
            self.get_buf().get_u8_at(self.offset + 21).into()
        }

        /// GROUP DECODER
        #[inline]
        pub fn levels_list_decoder(self) -> LevelsListDecoder<Self> {
            let acting_version = self.acting_version;
            LevelsListDecoder::default().wrap(self, acting_version as usize)
        }

    }

    #[derive(Debug, Default)]
    pub struct LevelsListDecoder<P> {
        parent: Option<P>,
        block_length: usize,
    ...
    impl<'a, P> Reader<'a> for LevelsListDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
    ...
    impl<'a, P> Decoder<'a> for LevelsListDecoder<P> where P: Decoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> LevelsListDecoder<P> where P: Decoder<'a> + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
            acting_version: usize,
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='levelsList', referencedName='null', description='null', packageName='null', id=6, version=0, deprecated=0, encodedLength=17, offset=22, componentTokenCount=20, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
